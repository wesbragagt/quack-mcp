...
class TestLoadExcelArgs:
    ...
    def test_valid_excel_file(self):
        ...
        args = LoadExcelArgs(
            file_path="/path/to/file.xlsx", sheet="Sheet1", range="A1:C10"
        )
...
class TestAnalyzeCSVArgs:
    ...
    def test_valid_args_with_columns(self):
        ...
        args = AnalyzeCSVArgs(table_name="test_table", columns=["col1", "col2", "col3"])
...
class TestDetectAnomaliesArgs:
    ...
    def test_invalid_severity_threshold(self):
        ...
        with pytest.raises(ValidationError):
            DetectAnomaliesArgs(table_name="test", severity_threshold="invalid")
