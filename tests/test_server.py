...
from quack_mcp.exceptions import QueryError
...
class TestQuackMCPServer:
    ...
    async def test_execute_query_failure(self, server: QuackMCPServer):
        ...
        with pytest.raises(QueryError):  # QueryError should be raised
...
class TestServerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_load_csv_tool_integration(
        self, server: QuackMCPServer, create_csv_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_query_tool_integration(
        self, server: QuackMCPServer, create_csv_file
    ):
